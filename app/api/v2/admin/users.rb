      ...
      class Users < Grape::API
        resource :users do
          ...
          params do
            requires :uid,
                     type: String,
                     message: 'admin.user.missing_uid',
                     allow_blank: { value: false, message: 'admin.user.empty_uid' },
                     desc: 'user uniq id'
            optional :state,
                     type: String,
                     allow_blank: { value: false, message: 'admin.user.empty_state' },
                     desc: 'user state'
            optional :otp,
                     type: Boolean,
                     allow_blank: { value: false, message: 'admin.user.empty_otp' },
                     desc: 'user 2fa status'
            optional :role,
                     type: String,
                     allow_blank: { value: false, message: 'admin.user.empty_role' },
                     desc: 'user role'
          ...
          namespace :labels do
            ...
            params do
              ...
              requires :key,
                       type: String,
                       message: 'admin.user.missing_key',
                       allow_blank: { value: false, message: 'admin.user.empty_key' },
                       desc: 'label key. [a-z0-9_-]+ should be used. Min - 3, max - 255 characters.'
              requires :value,
                       type: String,
                       allow_blank: { value: false, message: 'admin.user.empty_value' },
            ...
            params do
              ...
              requires :scope,
                       type: String,
                       message: 'admin.user.missing_scope',
                       allow_blank: { value: false, message: 'admin.user.empty_scope' },
                       desc: 'label key. [a-z0-9_-]+ should be used. Min - 3, max - 255 characters.'
              requires :value,
                       type: String,
                       message: 'admin.user.missing_value',
                       allow_blank: { value: false, message: 'admin.user.empty_value' },
                       desc: 'Label value.'
            end
            put do
